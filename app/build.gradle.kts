...
android {
    namespace = "com.example.promopingmobile"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.example.promopingmobile"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    buildTypes {
        debug {
            buildConfigField("String", "API_BASE_URL", "\"http://192.168.1.72:3000\"")
        }
        release {
            isMinifyEnabled = false
            proguardFiles(getDefaultProguardFile("proguard-android-optimize.txt"), "proguard-rules.pro")
            buildConfigField("String", "API_BASE_URL", "\"https://api.promoping.com\"")
        }
    }
}
